...
kshf.Countries = {
  ...
  index_name: {},
  data: [
    { alpha: 'AD', alpha3: 'AND', num: 020, name: "Andorra" },
    { alpha: 'AE', alpha3: 'ARE', num: 784, name: "United Arab Emirates" },
    { alpha: 'AF', alpha3: 'AFG', num: 004, name: "Afghanistan" },
    { alpha: 'AG', alpha3: 'ATG', num: 028, name: "Antigua and Barbuda" },
    { alpha: 'AI', alpha3: 'AIA', num: 660, name: "Anguilla" },
    { alpha: 'AL', alpha3: 'ALB', num: 008, name: "Albania" },
    { alpha: 'AM', alpha3: 'ARM', num: 051, name: "Armenia" },
    { alpha: 'AO', alpha3: 'AGO', num: 024, name: "Angola" },
    { alpha: 'AQ', alpha3: 'ATA', num: 010, name: "Antarctica" },
    { alpha: 'AR', alpha3: 'ARG', num: 032, name: "Argentina" },
    { alpha: 'AS', alpha3: 'ASM', num: 016, name: "American Samoa" },
    { alpha: 'AT', alpha3: 'AUT', num: 040, name: "Austria" },
    { alpha: 'AU', alpha3: 'AUS', num: 036, name: "Australia" },
    { alpha: 'AW', alpha3: 'ABW', num: 533, name: "Aruba" },
    { alpha: 'AX', alpha3: 'ALA', num: 248, name: "Åland Islands" },
    { alpha: 'AZ', alpha3: 'AZE', num: 031, name: "Azerbaijan" },
    { alpha: 'BA', alpha3: 'BIH', num: 070, name: "Bosnia and Herzegovina" },
    { alpha: 'BB', alpha3: 'BRB', num: 052, name: "Barbados" },
    { alpha: 'BD', alpha3: 'BGD', num: 050, name: "Bangladesh" },
    { alpha: 'BE', alpha3: 'BEL', num: 056, name: "Belgium" },
    { alpha: 'BF', alpha3: 'BFA', num: 854, name: "Burkina Faso" },
    { alpha: 'BG', alpha3: 'BGR', num: 100, name: "Bulgaria" },
    { alpha: 'BH', alpha3: 'BHR', num: 048, name: "Bahrain" },
    ...
    { alpha: 'BM', alpha3: 'BMU', num: 060, name: "Bermuda" },
    { alpha: 'BN', alpha3: 'BRN', num: 096, name: "Brunei Darussalam" },
    { alpha: 'BO', alpha3: 'BOL', num: 068, name: "Bolivia, Plurinational State of" },
    { alpha: 'BQ', alpha3: 'BES', num: 535, name: "Bonaire, Sint Eustatius and Saba" },
    { alpha: 'BR', alpha3: 'BRA', num: 076, name: "Brazil" },
    { alpha: 'BS', alpha3: 'BHS', num: 044, name: "Bahamas" },
    { alpha: 'BT', alpha3: 'BTN', num: 064, name: "Bhutan" },
    { alpha: 'BV', alpha3: 'BVT', num: 074, name: "Bouvet Island" },
    { alpha: 'BW', alpha3: 'BWA', num: 072, name: "Botswana" },
    { alpha: 'BY', alpha3: 'BLR', num: 112, name: "Belarus" },
    { alpha: 'BZ', alpha3: 'BLZ', num: 084, name: "Belize" },
    ...
    { alpha: 'DZ', alpha3: 'DZA', num: 012, name: "Algeria" },
    ...
    { alpha: 'IO', alpha3: 'IOT', num: 086, name: "British Indian Ocean Territory" },
    ...
    { alpha: 'SB', alpha3: 'SLB', num: 090, name: "Solomon Islands" },
    ...
    { alpha: 'TD', alpha3: 'TCD', num: 144, name: "Chad" },
    ...
    { alpha: 'VG', alpha3: 'VGB', num: 092, name: "Virgin Islands, British" },
